...
export default function ModeSelection({ onSelectMode, adminPassword = '1234' }: ModeSelectionProps) {
  ...
  return (
      <div className="size-full min-h-screen relative bg-black overflow-hidden flex flex-col">
        {/* 배경 그라디언트 효과 */}
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
          <div className="w-full max-w-6xl">
            ...
            */}
              ...
              {/* 타이틀 */}
              <h1 className="text-4xl sm:text-5xl lg:text-7xl mb-4 lg:mb-6 tracking-tight font-extrabold">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-4xl mx-auto px-4">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="text-left mb-4 lg:mb-6">
                    <h3 className="text-2xl lg:text-3xl text-white mb-2 lg:mb-3 group-hover:text-blue-300 transition-colors font-bold">
                      관리자 모드
                    </h3>
              ...
              >
                ...
                <div className="relative">
                  ...
                  {/* 텍스트 */}
                  <div className="text-left mb-4 lg:mb-6">
                    <h3 className="text-2xl lg:text-3xl text-white mb-2 lg:mb-3 group-hover:text-cyan-300 transition-colors font-bold">
                      작업자 모드
                    </h3>
                    <p className="text-gray-400 text-xs sm:text-sm leading-relaxed font-medium">
                      본인 확인 및 보호구 검사,<br />
